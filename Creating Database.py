...
db1.commit()
c1.execute("create table mem(mid varchar(20) primary key, \
name varchar(50), \
phone varchar(10), \
email varchar(50));")
...
c1.execute("create table issue(mid varchar(20), bookid varchar(20), doissue date);")
c1.execute("create table issuelog(mid varchar(20), bookid varchar(20), doissue date, doret date);")
